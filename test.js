 ...
 class AVL
    {
        ...
        preorderUtil( node)
        {
            ...
            let margin=200;     
            let parent=root;
            this.inorderUtil(this.root,type,parent,margin);
            }
            async inorderUtil(root,type,parent,margin){
                if(root!==null){
                    ...
                    this.inorderUtil(root.left,type,root,margin,root.x-margin);
                    ...
                    if(type==="animate")
                    await this.inorderUtil(root.right,type,root,margin,root.x+margin);
                    else 
                     this.inorderUtil(root.right,type,root,margin,root.x+margin);
